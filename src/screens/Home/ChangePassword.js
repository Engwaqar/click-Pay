...
const ChangePassword = ({ navigation }) => {
    ...
    const Validation = (item) => {
        ...
        if (OldPassword === "" && password === ""&& NewPassword==="") {
            ...
            setErrorString("Old Password is missing");
        } else if (NewPassword === "") {
            setErrorString("New Password is missing");
        }
         else if (password === "") {
          setErrorString("Confirm Password is missing");
        } 
        else {
                        ...
                        <View style={styles.footer}>
                            ...
                            <View >
                                ...
                                <Input
                                    ...
                                    onChnageText={(text) => setOldPassword(text.replace(/[- #*;,.<>\{\}\[\]\\\/]/gi, ''))}
                                ...
                                <Input
                                    ...
                                    margin={[30, 0, 10, 0]}
                                    backgroundColor={colors.white}
                                    onChnageText={(text) => setNewPassword(text.replace(/[- #*;,.<>\{\}\[\]\\\/]/gi, ''))}
                                    leftIcon={globalPath.Lock}
                                    // keyboardType={'numeric'}
                                    maxlength={11}
                                />
